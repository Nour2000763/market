    ...
    <!-- Modal -->
     <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <center><h1 class="h2 p-2 bg-success mb-2" style="border-radius:20px; color:white; box-shadow:0px 4px 8px rgba(0,0,0,0.2)">الاقسام</h1></center>
                    ...
                    القسم الحريمي
                     ...
                     <a class="collapsed d-flex justify-content-center h3 text-decoration-none p-2 mb-3 text-success" href="offers-shop.php" style="border-radius:20px;  box-shadow:0px 4px 8px rgba(0,0,0,0.2); color:black">
                    احدث العروض
                    </a>         
            ...
            <div class="col-lg-9">
                <h1 style="color:rgba(0,0,0,0.5)" class=" p-4">احدث العروض</h1>
                <div class="row">
