...
.features-small-item .features-title:hover{
    color:#59ab6e;
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Zomoroda</b> eCommerce</h1>
                                <h3 class="h2"> Perfect eCommerce for you</h3>
        ...
        <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success">Best Offers</h1>
                                <h3 class="h2">Sign In Now And Enjoy Shopping</h3>
...
<section>
    ...
    <div class="container py-5">
      ...
      <div class="col-lg-12 col-md-12 col-xs-12 main-nav">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <a href="offers.php" style="text-decoration:none;"><div class="features-small-item">
                                <div class="icon">
                                    <i class="fa fa-shopping-basket"></i>
                                </div>
                                <h5 class="features-title">احدث العروض</h5>
                                <p>نقدم لكم احدث العروض شاهد اخر العروض </p>
                                </div></a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.4s">
                              <a href="child.php" style="text-decoration:none;">
                                  <div class="features-small-item">
                                    <div class="icon">
                                    <i class="fa fa-shopping-basket"></i>
                                </div>
                                <h5 class="features-title">القسم الاطفالي</h5>
                             <p> افضل ملابس الاطفال تجدها عندنا تابعنا الان</p>
                        </div>
                            </a>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.6s">
                            <a href="women.php" style="text-decoration:none"><div class="features-small-item">
                                <div class="icon">
                                    <i class="fa fa-shopping-basket"></i>
                                </div>
                                <h5 class="features-title">القسم الحريمي</h5>
                                <p>احدث الموضات التي تناسب المرأه العصريه</p>
                            </div></a>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                    </div>
                ...
                <center><h1 style="color:rgba(0,0,0,0.5)" class=" p-4">احدث المنتجات | latest products</h1></center>
